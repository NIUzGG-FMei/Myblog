...
const remoteBackgroundVideoUrl = getPublicEnv("PUBLIC_BACKGROUND_VIDEO_URL");
const backgroundVideoUrl =
	remoteBackgroundVideoUrl || "/assets/videos/bg-nailong.mp4";

export const backgroundWallpaper: BackgroundWallpaperConfig = {
	// 壁纸模式："banner" 横幅壁纸，"fullscreen" 全屏壁纸，"overlay" 全屏透明，"none" 纯色背景无壁纸
	mode: "banner",
	// 是否启用背景视频播放，配置后将在导航栏显示视频播放按钮
	playerEnable: Boolean(backgroundVideoUrl),
	/**
	 * 背景图片配置
	 * 图片路径支持三种格式：
	...
	src: {
		desktop: [
			"assets/images/HomeWallpaper/奶龙力作1.png",
			"assets/images/HomeWallpaper/奶龙力作2.webp",
			"assets/images/HomeWallpaper/奶龙力作3.avif",
			"assets/images/HomeWallpaper/奶龙力作4.avif",
			"assets/images/HomeWallpaper/奶龙力作5.avif",
			"assets/images/HomeWallpaper/奶龙力作6.webp",
			"assets/images/HomeWallpaper/奶龙力作7.avif",
		],
		mobile: [
			"assets/images/HomeWallpaper/奶龙力作1.png",
			"assets/images/HomeWallpaper/奶龙力作2.webp",
