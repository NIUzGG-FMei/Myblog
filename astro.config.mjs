...
const adapter = cloudflare({
	// Node prerendering supports the blog's CommonJS plugins. In development,
	// bypass Cloudflare Images so Node never imports a Workerd-only endpoint.
	imageService:
...
export default defineConfig({
	...
	integrations: [
		...
		icon({
			// Astro Icon otherwise bundles every installed Iconify collection into
			// server-rendered routes. Keep this list exact so the Worker stays below
